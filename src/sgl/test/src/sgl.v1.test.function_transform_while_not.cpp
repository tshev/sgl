...
namespace test {
namespace function_transform_while_not {

void test() {
    sgl::v1::array<int> input = {1, 2, 3, 4};
    auto first0 = sgl::v1::begin(input);
    auto last0 = sgl::v1::end(input);
    {
        sgl::v1::array<int> output(input.size());
        auto out0 = output.begin();
        auto [input_l, output_l] = sgl::v1::transform_while_not(first0, last0, out0, [](int x) { return x >= 4; }, [](int x) { return x * x; });
...

    {
        ...
        auto out0 = output.begin();
        auto [input_l, output_l] = sgl::v1::transform_while_not(first0, first0, out0, [](int x) { return x >= 4; }, [](int x) { return x * x; });
...
int main() {
    sgl::v1::test::function_transform_while_not::test();
}
