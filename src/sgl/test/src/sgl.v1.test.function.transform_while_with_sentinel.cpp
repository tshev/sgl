...
namespace test {
namespace function_transform_while_with_sentinel {
...
void test() {
    ...
    auto first0 = sgl::v1::begin(input);
    {
        ...
        auto [input_l, output_l] = sgl::v1::transform_while_with_sentinel(first0, out0, [](int x) { return x < 4; }, [](int x) { return x * x; });
...
int main() {
    sgl::v1::test::function_transform_while_with_sentinel::test();
}
