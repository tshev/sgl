...
namespace test {
namespace function_transform_while {
...
void test() {
    ...
    auto last0 = sgl::v1::end(input);
    {
        ...
        auto [input_l, output_l] = sgl::v1::transform_while(first0, last0, out0, [](int x) { return x < 4; }, [](int x) { return x * x; });
...

    {
        ...
        auto out0 = output.begin();
        auto [input_l, output_l] = sgl::v1::transform_while(first0, first0, out0, [](int x) { return x < 4; }, [](int x) { return x * x; });
...
int main() {
    sgl::v1::test::function_transform_while::test();
}
