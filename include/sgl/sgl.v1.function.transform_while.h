...
OutputIterator transform_while(ForwardIterator first, OutputIterator output, Predicate predicate, Function function) {
...
OutputIterator transform_while(ForwardIterator0 first_0, ForwardIterator1 first_1, OutputIterator output, Predicate predicate, Function function) {
...
OutputIterator transform_while(ForwardIterator0 first_0, ForwardIterator1 first_1, ForwardIterator2 first_2, OutputIterator output, Predicate predicate, Function function) {
