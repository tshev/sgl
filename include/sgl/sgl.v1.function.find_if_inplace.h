...
inline
void find_if_inplace(ForwardIterator& first, ForwardIterator last, UnaryPredicate unary_predicate) {
  while (first != last) {
...
inline
void find_if_inplace(ForwardIterator0& first0, ForwardIterator0 last0, ForwardIterator1& first1, BinaryPredicate binary_predicate) {
  while (first0 != last0) {
