...
T sqrt_diff_square_sum(ForwardIterator0 f0, ForwardIterator0 l0,
                       ForwardIterator1 f1, T result) {
  while (f0 != l0) {
...
template <typename ForwardIterator0, typename ForwardIterator1, typename T,
          typename Projection0>
T sqrt_diff_square_sum(ForwardIterator0 f0, ForwardIterator0 l0,
                       ForwardIterator1 f1, T result, Projection0 p0) {
  while (f0 != l0) {
...
template <typename ForwardIterator0, typename ForwardIterator1, typename T,
          typename Projection0, typename Projection1>
T sqrt_diff_square_sum(ForwardIterator0 f0, ForwardIterator0 l0,
                       ForwardIterator1 f1, T result, Projection0 p0,
                       Projection1 p1) {
  while (f0 != l0) {
