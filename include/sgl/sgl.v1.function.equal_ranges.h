...
std::pair<ForwardIterator0, ForwardIterator1> equal_ranges(ForwardIterator0 first_0, ForwardIterator0 last_0, ForwardIterator1 first_1) {
  while (first_0 != last_0) {
    if (*first_0 == *first_1) {} else { return {first_0, first_1}; }
    ++first_0;
    ++first_1;
  }
...
*/
// requires(ForwardIterator(ForwardIterator0) && ForwardIterator(ForwardIterator1))
std::pair<ForwardIterator0, ForwardIterator1> equal_ranges(ForwardIterator0 first_0, ForwardIterator0 last_0, ForwardIterator1 first_1, ForwardIterator1 last_1, std::input_iterator_tag) {
...
std::pair<RandomAccessIterator0, RandomAccessIterator1> equal_ranges(RandomAccessIterator0 first_0, RandomAccessIterator0 last_0, RandomAccessIterator1 first_1,
...
*/
// requires(ForwardIterator(ForwardIterator0) && ForwardIterator(ForwardIterator1))
std::pair<ForwardIterator0, ForwardIterator1> equal_ranges(ForwardIterator0 first_0, ForwardIterator0 last_0, ForwardIterator1 first_1, ForwardIterator1 last_1) {
  ...
  if constexpr(std::is_same<typename std::iterator_traits<ForwardIterator0>::iterator_category, std::random_access_iterator_tag>::value &&
    ...
    return equal_ranges(first_0, last_0, first_1, last_1, std::random_access_iterator_tag{});
  }
  return equal_ranges(first_0, last_0, first_1, last_1, std::input_iterator_tag{});
#else
  return equal_ranges(first_0, last_0, first_1, last_1, std::input_iterator_tag{});
#endif
}
