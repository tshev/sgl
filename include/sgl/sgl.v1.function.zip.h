...
inline
std::pair<It0, It1> zip(It0 f0, It0 l0, It1 f1, It1 l1, F f, std::input_iterator_tag) {
    while (f0 != l0 && f1 != l1) {
        f(*f0, *f1);
        ++f0;
        ++f1;
...
inline
std::pair<It0, It1> zip(It0 f0, It0 l0, It1 f1, It1 l1, F f, std::random_access_iterator_tag) {
    if (l1 - f1 < l0 - f0) {
        while (f1 != l1) {
            f(*f0, *f1);
            ++f0;
...
//requires(ForawrdIterator(It0) && ForawrdIterator(It1) && BinaryFunction(F))
inline
std::pair<It0, It1> zip(It0 f0, It0 l0, It1 f1, It1 l1, F f) {
    ...
    typedef typename sgl::v1::if_else<enable_rai, std::random_access_iterator_tag, std::input_iterator_tag>::type iterator_category;
