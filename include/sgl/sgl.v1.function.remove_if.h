...
ForwardIterator0 remove_if(ForwardIterator0 first, ForwardIterator0 last, UnaryPredicate predicate) {
...
std::pair<ForwardIterator0, ForwardIterator1> remove_if(ForwardIterator0 first, ForwardIterator0 last, ForwardIterator1 first1, UnaryPredicate predicate) {
    sgl::v1::find_if_inplace(first, last, first1, predicate);
