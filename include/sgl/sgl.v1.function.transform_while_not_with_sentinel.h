...
inline
std::pair<ForwardIterator, OutputIterator> transform_while_not_with_sentinel(ForwardIterator first, OutputIterator output, Predicate predicate, Function function) {
...
inline
sgl::v1::triple<ForwardIterator0, ForwardIterator1, OutputIterator> transform_while_not_with_sentinel(ForwardIterator0 first0, ForwardIterator1 first1, OutputIterator output, Predicate predicate, Function function) {
...
inline
OutputIterator transform_while_not_with_sentinel(ForwardIterator0 first0, ForwardIterator1 first1, ForwardIterator2 first2, OutputIterator output, Predicate predicate, Function function) {
